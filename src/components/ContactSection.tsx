  ...
  return (
    <section id="contato" className="section-padding bg-muted/20">
      <div className="container mx-auto">
        ...
        >
          <span className="text-primary font-bold text-sm uppercase tracking-[0.2em]">Fale Conosco</span>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 bg-secondary text-secondary-foreground px-10 py-5 rounded-2xl font-black text-xl uppercase tracking-wider hover:brightness-110 transition shadow-2xl shadow-secondary/30 disabled:opacity-50"
            >
          ...
          >
            <div className="bg-white border border-border rounded-3xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <h3 className="font-display text-2xl font-bold mb-8 text-foreground">Informações de Contato</h3>
              <div className="space-y-6">
                <a href="tel:+258856494575" className="flex items-center gap-5 text-muted-foreground hover:text-primary transition-all group">
                  ...
                  <span className="font-bold text-foreground">+258 856 494 575</span>
                </a>
                <a href="mailto:machineryparts.procurement@gmail.com" className="flex items-center gap-5 text-muted-foreground hover:text-primary transition-all group">
                  <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                    <Mail size={24} className="text-primary group-hover:text-white" />
                  </div>
                  <span className="font-bold truncate text-foreground">machineryparts.procurement@gmail.com</span>
                </a>
                <div className="flex items-center gap-5 text-muted-foreground group">
                  <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center">
                    <MapPin size={24} className="text-primary" />
                  </div>
                  <span className="font-bold text-foreground">Maputo, Moçambique</span>
                </div>
              </div>
            </div>
            <motion.a 
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-3 bg-[hsl(142,70%,40%)] text-white px-8 py-5 rounded-2xl font-black text-xl uppercase tracking-wider hover:brightness-110 transition shadow-2xl shadow-green-600/20 w-full"
            >
